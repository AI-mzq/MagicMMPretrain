...
# @Create Time : 2023/6/9 15:45
# @Author :      ai-mzq
# @File name:    dataset_split.py
# @Software:     PyCharm
...
if __name__ == '__main__':
    src_data_folder = "/data/mzq/temp/fruit30_cls_data/fruit30_datasets"
    target_data_folder = "/data/mzq/temp/fruit30_cls_data/fruit30_split_dataset"
